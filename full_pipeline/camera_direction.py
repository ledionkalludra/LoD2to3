...
# === Konfiguration ===
sfm_path = pathlib.Path(r"D:\DHBW\Studienarbeit\project2\MeshroomCache\StructureFromMotion\1808e77d8865b48ab74d68fcb3ba05743731902e\cameras.sfm")
#csv_path = pathlib.Path(r"C:\Users\ledio\OneDrive\Studienarbeit\Code\full_pipeline_V2\kameras_mit_gps.csv")
#img_root = pathlib.Path(r"D:\DHBW\Studienarbeit\data")
...
# === Hauptfunktion ===
def process_camera_csv(img_root):
